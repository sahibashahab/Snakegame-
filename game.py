...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode((800, 600))  # Updated screen size
        self.snake = Snake(self.surface)
        self.apple = Apple(self.surface)
        self.play_background_music()

        self.restart_button = Button(600, 500, 180, 50, "Restart Game")
        self.quit_button = Button(600, 560, 180, 50, "Quit Game")
    ...
    def show_game_over(self):
        ...
        line2 = font.render("Choose an option:", True, (255, 255, 255))
